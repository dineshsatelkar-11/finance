-- Warana Current opening = end of 26-Aug-2026 statement balance (11390.30 stored as 11390).
-- Statement rows 27-Aug to 04-Sep are seeded client-side on hydrate (fixed ids in sync.ts).
