...
export function PaySheet({
  ...
  function goConfirm() {
    ...
    // UPI QR can open without a locked amount (payer types it in the app).
          ...
          <div className="space-y-4">
            ...
            {mode === "upi" ? (
              <>
                    ...
                    onClick={() => {
                      ...
                      copy(
                        payPacketText({
                          vpa,
                          payeeName: payee || driver?.name || "",
                          amount: Number.isFinite(a) && a > 0 ? a : undefined,
                        }),
                        "Pay details",
                      );
                    }}
                ...
                <Button variant="navy" className="w-full" onClick={() => openApp("generic")}>
