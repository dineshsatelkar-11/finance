...
function ensureWsbLoan015AndCc(): boolean {
  ...
  // Loan …015 disbursed into Current on 09-Sep, then RTGS to Laxmi Motors (expense already seeded)
  ...
  const payouts: PSeed[] = [
    ...
    po("po_stmt_20260907_sandeep_er_250", "Sandeep", "extra_route", 250, "2026-09-07", "UPI Vikas · statement"),
  ...
  // Reclassify: 11-Sep ₹1102 was expense → Anand advance
