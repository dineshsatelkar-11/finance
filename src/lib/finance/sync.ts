...
function ensureWsbLoan015AndCc(): boolean {
  ...
  const xfers: BankTransfer[] = [
    ...
    {
      id: "xfer_own_to_cur_10k_20260916",
      fromBankId: ccId,
      toBankId: currentId,
      amount: 10000,
      date: "2026-09-16",
      note: "OWN ADVANCE → Current · statement",
      createdAt: "2026-09-16T12:00:00.000Z",
    },
    {
      id: "xfer_own_to_cur_31k_20260916",
      fromBankId: ccId,
      toBankId: currentId,
      amount: 31000,
      date: "2026-09-16",
      note: "OWN MACRO BODY → Current · statement",
      createdAt: "2026-09-16T12:30:00.000Z",
    },
    {
      id: "xfer_own_to_cur_25k_20260918",
      fromBankId: ccId,
      toBankId: currentId,
      amount: 25000,
      date: "2026-09-18",
      note: "OWN → Current · statement",
      createdAt: "2026-09-18T12:00:00.000Z",
    },
    {
      id: "xfer_own_to_cur_2k_20260918",
      fromBankId: ccId,
      toBankId: currentId,
      amount: 2000,
      date: "2026-09-18",
  ...
  if (
    !deletedIds.has(disbId) &&
    !useFinance.getState().loanPayments.some((p) => p.id === disbId)
  ) {
    useFinance.setState((state) => ({
      loanPayments: [
        {
  ...
  const WSB_MINI_LOANS: Loan[] = [
    {
      id: "loan_wsb_000010",
      name: "WSB Mini — A/c …000010",
      bank: "Warana Sahakari Bank (HDFC0CSWSBL)",
      accountNo: "3970254350000010",
      ifsc: "HDFC0CSWSBL",
      principal: 379000,
      emiAmount: 7960,
      emiDay: 19,
      ...
      status: "active",
      fleetId: null,
      note: "SATELKARS LOGISTIC · Customer ID 554827",
    },
    {
      id: "loan_wsb_000012",
      name: "WSB Mini — A/c …000012",
      bank: "Warana Sahakari Bank (HDFC0CSWSBL)",
      accountNo: "3970254350000012",
      ifsc: "HDFC0CSWSBL",
      principal: 379000,
      emiAmount: 7960,
      emiDay: 13,
  ...
  const emiSeeds: { id: string; loanId: string; amount: number; note: string }[] = [
  ...
  if (useFinance.getState().expenses.some((e) => e.id === WRONG_ANAND_EXP)) {
    useFinance.setState((state) => ({
      expenses: state.expenses.filter((e) => e.id !== WRONG_ANAND_EXP),
    }));
    changed = true;
  }
