...
function ExpensesPage() {
  ...
  const [editMode, setEditMode] = useState<PayMode>("upi");
  ...
  function openEditExpense(e: Expense) {
    ...
    setEditMode(e.mode || "upi");
    setEditBankId(e.bankAccountId || defaultBankId());
  }
  ...
  function saveEditExpense() {
    ...
    updateExpense(editRow.id, {
      ...
      category: editCat,
      mode: editMode,
      bankAccountId: editBankId || defaultBankId(),
    });
          ...
          <div className="space-y-4 text-left">
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <Select value={bankId || defaultBankId()} onValueChange={setBankId}>
                  <SelectTrigger>
      ...
      <Dialog open={!!editRow} onOpenChange={(o) => !o && setEditRow(null)}>
        <DialogContent title="Edit expense">
          <div className="space-y-4 text-left">
            ...
            <div className="space-y-1.5">
              <Label>Mode</Label>
              <Select value={editMode} onValueChange={(v) => setEditMode(v as PayMode)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5">
              <Label>Paid from</Label>
              <Select value={editBankId || defaultBankId()} onValueChange={setEditBankId}>
                <SelectTrigger>
                  <SelectValue placeholder="Select account" />
                </SelectTrigger>
                <SelectContent>
