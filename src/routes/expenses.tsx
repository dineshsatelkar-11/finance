...
function ExpensesPage() {
  ...
  function save() {
    ...
    const r = record({
      ...
      date,
      mode,
      bankAccountId: bankAccountId || defaultBankId(),
          ...
          <div className="space-y-4 text-left">
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <Select value={bankAccountId || defaultBankId()} onValueChange={setBankAccountId}>
                  <SelectTrigger>
      ...
      <Card>
        ...
        <Button
          ...
          onClick={() => {
            ...
            if (!name?.trim()) return;
            const upi = window.prompt("UPI ID (optional — one-time setup)") || "";
            const id = uid("vnd");
            upsertVendor({
              id,
              name: name.trim(),
